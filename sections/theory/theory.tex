...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \label{fig:theory-original-torus}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{0.46\textwidth}
        ...
        \label{fig:theory-original-monkey}
    \end{subfigure}
    \hfill
...
\begin{figure}[p]
    ...
    \end{subfigure}
    \hfill
    \caption{Voxelization of an anvil with Voxelizer v0.1.3. The voxelization is done with a resolution of $2^7$.}
